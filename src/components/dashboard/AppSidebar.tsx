        ...
        <aside className="hidden border-r border-border bg-card lg:block">
            <div className="sticky top-0 flex flex-col h-dvh overflow-y-auto shadow-2xl bg-card p-4 ">
                <div className="flex flex-col px-2 py-2 ">
                    ...
                    <div className="mt-4">
                        <p className="mt-3 font-semibold font-sans">
                            Menu
                        </p>
                    ...
                    <div className="
                            mt-5 bg-primary/80 rounded-2xl h-40 w-58 text-primary
                            px-4 py-4  gap-4
                            ">
                        ...
                        <div className="flex flex-row py-8 gap-4 font-semibold font-sans text-foreground cursor-pointer">
                                <NavLink
                                to="/tasks"
